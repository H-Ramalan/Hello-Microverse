...
> The project is built using client side technologies.
...
> To use this project, you will need a few tools;

To get a local copy up and running, follow these steps.

### Prerequisites

In order to run this project you will need a code editor, browser, git, NPM.
...
cd my-folder <br>
git clone git@github.com:H-Ramalan/Hello-Microverse.git<br>
cd my-project
...
Install this project with: You can install the Microverse linters by following <a href="https://github.com/microverseinc/linters-config">these</a> steps.
...
- **[will there be additional features?]**
  ...
  - [Unfortunately, it is a simple project with very little chance of having any addedfeatures in the future.]
